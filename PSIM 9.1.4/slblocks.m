...
%   $Revision: 1.2 $  $Date: 2002/04/09 19:37:39 $

%
% Name of the subsystem which will show up in the Simulink Blocksets
% and Toolboxes subsystem.
%
blkStruct.Name = ['S-function' sprintf('\n') 'SimCoupler'];

%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'SimCoupler';
...
%
blkStruct.MaskDisplay = 'disp(''S-fcn\nSimCoupler'');';
...
Browser(1).Library = 'PSimModel';
Browser(1).Name    = 'S-function SimCoupler';
